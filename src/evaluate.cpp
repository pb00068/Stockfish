...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score ThreatByMinor[PIECE_TYPE_NB] = {
    S(0, 0), S(0, 31), S(31, 38), S(57, 44), S(68, 112), S(47, 120)
  };
  ...
  constexpr Score KnightMultiThreat  = S(  6,  2);
        ...
        while (b)
        {
            ...
            if (type_of(pos.piece_on(s)) != PAWN)
            {
                ...
                if (!multi && (attackedBy[Us][KNIGHT] & s)) {
                	Bitboard targets = pos.pieces(Them, QUEEN, ROOK) | pos.pieces(Them, KING) | (pos.pieces(Them, BISHOP, PAWN) & ~attackedBy[Them][PAWN]);
