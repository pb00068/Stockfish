...
#undef S
  ...
  Score Evaluation<T>::pieces() {
    ...
    while ((s = *pl++) != SQ_NONE)
    {
    	bb = ((attackedBy[Us][PAWN] | attackedBy[Us][KNIGHT]) & s) ? pos.pieces(QUEEN) : pos.pieces(Us, QUEEN);
        // Find attacked squares, including x-ray attacks for bishops and rooks
        b = Pt == BISHOP ? attacks_bb<BISHOP>(s, pos.pieces() ^ bb)
          : Pt ==   ROOK ? attacks_bb<  ROOK>(s, pos.pieces() ^ bb ^ pos.pieces(Us, ROOK))
