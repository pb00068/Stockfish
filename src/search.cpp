...
namespace {
  ...
  void update_quiet_stats(const Position& pos, Stack* ss, Move move, int bonus, bool pvnode);
...
moves_loop: // When in check, search starts from here
  ...
  void update_all_stats(const Position& pos, Stack* ss, Move bestMove, Value bestValue, Value beta, Square prevSq,
    ...
    {
        update_quiet_stats(pos, ss, bestMove, bonus2, pvnode);
  ...
  void update_quiet_stats(const Position& pos, Stack* ss, Move move, int bonus, bool pvnode) {
    ...
    if ( pvnode && ( pos.slidesThrough(from_sq(move), (ss+1)->currentMove, ~us)
