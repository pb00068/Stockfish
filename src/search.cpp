          ...
          && bestValue > VALUE_TB_LOSS_IN_MAX_PLY)
      {
              ...
              || givesCheck)
          {
              ...
              if (   !givesCheck
                  ...
                  continue;
              // SEE based pruning
              if (!pos.see_ge(move, Value(-208 - 30 * (bool)(ss->staticEval - 140 > alpha )) * depth)) // (~25 Elo)
                  continue;
          }
          else
          {
              ...
              if (!pos.see_ge(move, Value((-20 -2 * (bool)(ss->staticEval - 140 > alpha )) * lmrDepth * lmrDepth - 20 * lmrDepth)))
                  continue;
          }
      }
