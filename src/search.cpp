                            ...
                            : (tte->bound() & BOUND_UPPER)))
    {
        ...
        if (ttMove)
        {
            if (ttValue >= beta)
            {
                ...
                // Extra penalty for a quiet TT or killer move in previous ply when it gets refuted
                if (((ss-1)->moveCount == 1 || ((ss-1)->currentMove == (ss-1)->killers[0] && (ss-1)->killers[0])) && !pos.captured_piece())
