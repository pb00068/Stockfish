...
moves_loop: // When in check, search starts from here
    ...
    while ((move = mp.next_move(skipQuiets)) != MOVE_NONE)
    {
      ...
      bool capturedPiece = pos.captured_piece();
          ...
          && (!captureOrPromotion || moveCountPruning))
      {
          ...
          else
          {
              ...
              // Decrease reduction if prior move was a capture
          	  r = std::max(DEPTH_ZERO, (r / ONE_PLY - (ss->statScore + capturedPiece * 2000) / 20000) * ONE_PLY);
          }
