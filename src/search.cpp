...
moves_loop: // When in check search starts from here
    ...
    */
    ...
    else if (bestMove)
    {
        ...
        else if (ttMove && ttMove != bestMove && !ss->killers[2] && pos.capture_or_promotion(ttMove) && !pos.see_ge(ttMove))
        	ss->killers[2] = ttMove; // this 'bad' capture might still be good in sibling nodes
