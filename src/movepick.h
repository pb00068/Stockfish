...
/// ClearanceHistory is like ButterflyHistory but is addressed by a move's [color][from]
typedef Stats<int16_t, 29952, COLOR_NB, SQUARE_NB> ClearanceHistory;
...
private:
  ...
  const ClearanceHistory* clr_History;
  Move ttMove;
