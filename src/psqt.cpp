...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-53,-57), S( -5,-30), S(-10,-37), S(-25,-10) },
   { S(-15,-37), S(  8,-13), S( 24,-17), S(  4,  4) },
   { S( -7,-16), S( 25, -1), S( -4, -2), S( 17, 10) },
   { S( -5,-20), S( 11, -6), S( 25,  0), S( 39, 17) },
   { S(-17,-17), S( 20, -1), S( 22,-14), S( 31, 15) },
   { S(-24,-30), S(  6,  6), S(  1,  4), S( 11,  6) },
   { S(-23,-31), S(-14,-20), S(  5, -1), S(  0,  1) },
