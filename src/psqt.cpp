...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   ...
   { S(-20,-34), S( 18, -9), S( 12,-14), S(  1,  4) },
   { S( -9,-23), S( 27,  0), S( 19, -3), S( 11, 16) },
   { S(-11,-26), S( 28, -3), S( 21, -5), S(  9, 16) },
   { S(-11,-26), S( 27, -4), S( 16, -7), S(  8, 14) },
   { S(-17,-24), S( 16, -2), S( 10,  0), S(  2, 13) },
   { S(-23,-34), S( 15,-10), S(  6,-12), S( -2,  6) },
